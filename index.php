...
if(!isset($_GET['destino'])){
  if(!isset($_GET['lat']) OR !isset($_GET['long'])){
    $lat = -23.592463352512073;
    $long = -46.650821024374345;
    $criar_rota = 0;
    $destino_voz = '""';
  }else{
    $criar_rota = 0;
...
<!-- Modal -->
<div class="modal fade" id="exampleModalCenter" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true"  style="margin-top: 100px;margin-left: 40px;margin-right: 40px">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary button_class" data-dismiss="modal">fechar</button>
        <button type="button" class="btn btn-primary button_class" onclick="calcularRota()" >gerar rota</button>
      </div>
    </div>
  </div>
</div>
